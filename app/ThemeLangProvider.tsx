...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    cta_direct: 'Direct APK Download (Beta)',
    cta_direct_note: 'Android only · Enable "Install from unknown sources" in settings',
  ...
  fr: {
    ...
    cta_direct: 'Téléchargement APK direct (Bêta)',
    cta_direct_note: 'Android uniquement · Activez "Sources inconnues" dans les paramètres',
  ...
  yo: {
    ...
    cta_direct: 'Gba APK Tààrà (Beta)', cta_direct_note: 'Android nìkan · Mú "Àwọn Orísun Àìmọ̀" ṣiṣẹ nínú ètò',
  ...
  ha: {
    ...
    cta_direct: 'Zazzage APK Kai Tsaye (Beta)', cta_direct_note: 'Android kawai · Kunna "Tushen da ba a sani ba" a saitunan',
  ...
  ig: {
    ...
    cta_direct: 'Budata APK Ozugbo (Beta)', cta_direct_note: 'Android naanị · Mee ka "Isi iyi amaghị" arụ ọrụ na ntọala',
